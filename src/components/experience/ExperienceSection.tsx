      ...
      <div className="flex w-full flex-col">
        <div className="flex w-full justify-between items-center">
          <div className="flex flex-col">
            <p className="font-bold text-xl text-sky-900 dark:text-sky-300">{jobTitle}</p>
            <p className="text-md text-gray-600 dark:text-gray-300">{jobDescription}</p>
          </div>
          <div>
        ...
        <div className="flex items-center">
          <p className="text-xs text-sky-600 dark:text-sky-200 min-w-fit">Tech Stack</p>
